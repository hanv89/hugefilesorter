...
${OBJECTDIR}/src/SimpleNumberParser.o: src/SimpleNumberParser.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SimpleNumberParser.o src/SimpleNumberParser.cpp
...
${OBJECTDIR}/src/Configurations.o: src/Configurations.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Configurations.o src/Configurations.cpp
